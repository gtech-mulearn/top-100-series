  ...
  return (
    <div className="w-full bg-background relative overflow-hidden py-14">
      ...
      <div className="flex w-full justify-between items-center">
        <img src={grid} className="w-[25%] h-auto" alt="" />
        <h3 className="hatten-font text-[#D3184F] text-5xl sm:text-[calc(100vh/5)] lg:text-[calc(100vh/4)] leading-none">
          TIMELINE
        </h3>
        <img src={grid} className="w-[25%] h-auto" alt="" />
      </div>

      <div className="mt-16 flex flex-col gap-8 sm:gap-5 px-5 md:px-10 lg:px-16 xl:px-24">
        ...
        <div className={`w-full flex relative`}>
          ...
          />
          <img src={Arrow1} className="max-sm:hidden" alt="" />
        </div>
        ...
        <div className={`w-full flex flex-row-reverse gap-14`}>
          <TimelineCard
            ...
            className="sm:mt-10"
          />
          <img src={Arrow2} className="mt-32 max-sm:hidden" alt="" />
        </div>
        ...
        <div className={`w-full flex flex-row-reverse gap-14`}>
          ...
          />
          <img src={Arrow3} className="max-sm:hidden" alt="" />
        </div>
        ...
        <div className={`w-full flex justify-center gap-14`}>
          <TimelineCard
            ...
            className={"sm:mt-20"}
          />
          <img src={Arrow4} className="w-40 max-sm:hidden" alt="" />
        </div>

      </div>
      <img
        src={elipse}
        className="w-[70%] h-auto absolute top-0 left-0"
        alt=""
      />
    </div>
  );
